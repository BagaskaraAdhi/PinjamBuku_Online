                                            ...
                                            <header class="panel-heading">
                                                ...
                                                ?>
                                                    <div class="alert alert-success">
                                                        ...
                                                        <strong><?php echo $data3['fullname']; ?></strong>, Telah ditambahkan menjadi admin Pinjam Buku yang baru. 
                                                    </div>
                                                <?php } ?>
                                                ...
                                                ?>
                                                    <div class="alert alert-info">
                                                        ...
                                                        <strong><?php echo $data4['judul']; ?></strong>, Buku bacaan baru yang ada di Pinjam Buku.
                                                    </div>
                                                <?php } ?>
                                                ...
                                                ?>   
                                                    <div class="alert alert-warning">
                                                        ...
                                                        <strong><?php echo $data5['nama']; ?> </strong> Pengunjung baru di Pinjam Buku.
                                                    </div>
                                                <?php } ?>
                                                </div>
                                        </section>
