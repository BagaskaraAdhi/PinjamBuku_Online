...
<head>
    <meta charset="UTF-8">
    <title>Pinjam Buku Online</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta name="description" content="Pinjam Buku Online">
...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di Pinjam Buku Online Berbasis web, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Pinjam Buku Online</h4>
      </div>
      <div class="modal-body">
      Pinjam Buku Online adalah aplikasi perpustakaan bebasis website yang responsif, Pinjam Buku Online dibuat oleh
       Beberapa orang diantara lain:
      <table>
      <tr>
      <td>Bagaskara Adhi Pradana</td> <td>:</td> <td>Project Manager</td>
      </tr>
      <br />
      <tr>
      <td>Damar Radhitya Qolbi Budimulyo</td><td>:</td> <td>System Analist</td>
      </tr> 
      <br />
      <tr>
      <td>Muhammad Irfan Arifandi</td><td>:</td> <td>Programmer</td>
      </tr>
      <br />
      <tr>
      <td>Raphael Gregory Sosiawan</td>    <td>:</td> <td>System Designer</td>
      </tr>
       </table>
      </div>
